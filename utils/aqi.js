 ...
 * @returns {string}
 */
export function getAqiLevels(aqi) {
  if (aqi <= 50) {
    return '优';
  } else if (aqi <= 100) {
    return '良';
 ...
 * @returns {number}
 */
export function getAqiNumLevel(aqi) {
  aqi = parseInt(aqi);
  if (aqi>0&&aqi <= 50) {
    return 1;
  } else if (aqi <= 100) {
 ...
 * @returns {string}
 */
export function getPollLevelTextColor(polltype, pollvalue, timetype)
{
 ...
 * @returns {string}
 */
export function getPollLevelColor(polltype, pollvalue, timetype)
{
  if(pollvalue==null||pollvalue<0){
    return "#999999";
  }
 ...
 * @return {number}
 */
export function getPollLevel(polltype, pollvalue, timetype) {
 ...
 * @returns {*}
 */
export  function getPriPolName(polName) {
  if (polName != null) {
